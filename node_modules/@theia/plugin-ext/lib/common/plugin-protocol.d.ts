...
import { PLUGIN_HOST_BACKEND, PLUGIN_HOST_FRONTEND, PluginEntryPoint, PluginLifecycle, PluginManifest, PluginMetadata, PluginModel, PluginPackageCapabilities, PluginType, DeployedPlugin as DeployedPluginBase } from '@theia/plugin-utils/lib/common/manifest-types';
...
export { PLUGIN_HOST_BACKEND, PLUGIN_HOST_FRONTEND, PluginEntryPoint, PluginLifecycle, PluginManifest, PluginModel, PluginPackageCapabilities, PluginMetadata, PluginType };
