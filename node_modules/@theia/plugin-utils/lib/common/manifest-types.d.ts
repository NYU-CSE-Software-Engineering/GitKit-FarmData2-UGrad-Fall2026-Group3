...
export declare const PLUGIN_HOST_FRONTEND: "frontend";
...
export declare function rawContributes(manifest: Pick<PluginManifest, 'contributes'>): PluginManifestContribution;
