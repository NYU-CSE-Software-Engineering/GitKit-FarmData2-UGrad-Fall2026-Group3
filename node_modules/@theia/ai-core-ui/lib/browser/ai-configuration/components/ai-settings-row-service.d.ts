...
import { AiConfigurationSettingCommandArgs } from '../ai-configuration-setting-commands';
 ...
 */
export declare class AiSettingsRowService {
...
//# sourceMappingURL=ai-settings-row-service.d.ts.map